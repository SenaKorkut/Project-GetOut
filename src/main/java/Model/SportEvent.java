...
public class SportEvent extends Event{
     ...
     */
    public SportEvent(String title, String place, String date, String deadline, int numberOfParticipants, String description, String username ) {
        super( title, place, date, deadline, numberOfParticipants, description, username );
        super.setType("sport_events");
    }
