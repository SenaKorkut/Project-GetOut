...
public class GroupWorkEvent extends Event{
     ...
     */
    public GroupWorkEvent(String title, String place, String date, String deadline, int numberOfParticipants, String description, String username ) {
        super( title, place, date, deadline, numberOfParticipants, description, username );
        super.setType( "group_work_events" );
    }
